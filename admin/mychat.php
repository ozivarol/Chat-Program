<div class="col-lg-4">
	...
	?>
		<div class="panel-heading"><center><strong>Yonetici Cet Odalari <span class="badge"><?php echo $numme; ?></span></strong></center></div>
							...
							<td>
								<?php
									...
									if (mysqli_num_rows($memb)>0){
										?>
										<button type="button" class="btn btn-danger btn-sm delete2" value="<?php echo $myrow['chatroomid']; ?>">Sil</button>
										<?php
									}
									else{
										?>
										<button type="button" class="btn btn-warning btn-sm leave2" value="<?php echo $myrow['chatroomid']; ?>">Ayril</button>
										<?php
									}
								?>
							</td>
