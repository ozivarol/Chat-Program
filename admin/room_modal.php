        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Odadan Ayriliyorsun...</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
					<h3><center>Emin misin?</center></h3>
					<span style="font-size: 11px;"><center><i>Uyari: Bir kez sifreli odadan cikarsan tekrar katilmak icin sifre girmen gerekir!</i></center></span>
                </div> 
				</div>
    ...
    <div class="modal fade" id="add_member" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Kullanici Ekle</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
